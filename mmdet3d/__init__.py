...
# Monkey-patch: allow duplicate module registration (force=True by default)
_original_register_module = mmcv.utils.Registry._register_module
def _patched_register_module(self, module=None, module_name=None, force=False, **kwargs):
    if module is not None:
        return _original_register_module(self, module=module, module_name=module_name, force=True, **kwargs)
    def wrapper(cls):
        return _original_register_module(self, module=cls, module_name=module_name, force=True, **kwargs)
    return wrapper
mmcv.utils.Registry._register_module = _patched_register_module
